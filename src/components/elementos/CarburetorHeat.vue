<template>  
    <div class="palanca"> 
        ...
        <div  id="carburetor" >  
            <div id="circle-carburetor" @click="change"></div>
        </div>
...
<script>
  export default {
    ...
    methods:{
        change(){      // el metodo change lo que hace es cambiar el tamaño del carburador             
           if(this.cont == 1){   // cuando es uno el cont, el carburador se agranda y se tira hacia afuera
           ...
           }else{  // cuando el cont es dos, el carburador se vuelve a achicar o se tira para adentro
