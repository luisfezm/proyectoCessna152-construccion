<template>
  ...
  <div class="frontView">
    ...
    <div class="aileron left_Yellow" ref="left_Yellow"></div>
    <div class="aileron rigth_Yellow" ref="rigth_Yellow"></div>
    <div class="flaps left_green" ref="left_green"></div>
    <div class="flaps rigth_green" ref="rigth_green"></div>
    <div class="elevators left_blue" ref="left_blue"></div>
    <div class="elevators rigth_blue" ref="rigth_blue"></div>
    <div class="rudder" ref="red_rudder"></div>
