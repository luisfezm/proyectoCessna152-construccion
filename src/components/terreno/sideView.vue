<template>
  <div class="imagenCessna">
    <img
      src="https://i.imgur.com/5SjqiUf.png"
      :style="{ transform: imageTransformCola, transformOrigin: 'left center' }"
    />
    <img
      src="https://i.imgur.com/mWvEqGj.png"
      :style="{ transform: imageTransform, transformOrigin: 'left center' }"
    />
    <img
      src="https://i.imgur.com/E73yWP5.png"
      :style="{ transform: imageTransformAla, transformOrigin: 'left center' }"
    />
    <img
      src="https://i.imgur.com/WsPdnoR.png"
      :style="{
        transform: imageTransformWingFlaps,
    ...
    <img
      src="https://i.imgur.com/E73yWP5.png"
      :style="{
        transform: imageTransformAlaAtras,
        transformOrigin: 'left center',
      }"
    />
    <img
      src="https://i.imgur.com/L1kG2Gu.png"
      style="
        width: 25px;
        height: 110px;
        position: relative;
  ...
  export default {
    ...
    computed: {
      ...
      imageTransformCola() {
        ...
        return `scale(0.7) translate(${
          translateX - imageWidth
        }px, ${translateY}px) rotateY(${this.anguloRudder}deg)`
      },
      imageTransformAla() {
        ...
        return `scale(0.5) translate(${
          translateX + imageWidth
        }px, ${translateY}px) rotateZ(${this.anguloAmarillo}deg)`
      },
...
<style>
  ...
  .imagenCessna {
    ...
    align-items: center;
    position: relative;
    transform: scale(0.65) translateX(-70px) translateY(200px);
    align-items: center;
